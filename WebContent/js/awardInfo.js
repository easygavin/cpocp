...
define([
    ...
    var lotteryTypeArray = "11|13|31|12|14|36|46";
    ...
    var addItem = function (item) {
        ...
        var $p1 = $("<p></p>");
        $p1.html("<i class=c000>" + title + "</i><i class='mlr10'>第" + item.issueNo + "期</i>");
        var html = "";
        if (reds != null) {
            ...
            if ($.trim(lotteryType) != "") {
                switch (lotteryType) {
                    ...
                    case "36": // 竞彩篮球
                        ...
                        break;
                    case "46": // 竞彩足球
                        page.initPage("jczq/history", {date:""}, 1);
                        break;
                }
